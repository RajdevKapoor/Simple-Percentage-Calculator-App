package com.rdappz.pcalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float percent= Float.parseFloat(edtEnterPercent.getText().toString());
                float num= Float.parseFloat(edtEnterNumber.getText().toString());
